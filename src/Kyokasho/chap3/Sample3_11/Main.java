package Kyokasho.chap3.Sample3_11;
...
public class Main {
    public static void main(String[] args) {
        ...
        // char型から数値に変換
        char g = 'g'; byte charb = (byte)g;
        char h = 'h'; short chars = (short)h;
        char ci = 'i'; int chari = ci;
        char j = 'j'; long charl = j;
        char k = 'k'; float charf = k;
        char cl = 'l'; double chard = cl;
        ...
        short s1 = 1, s2 = 2;
        // short s3 = s1 + s2;            // コンパイルエラー、右辺はint型
